...
namespace DataManager
{
    public class Stub :Loader
    {
        ...
        public Stub(string Path=""):base(Path)
        {
            ...
            Jeux.Add(new Launcher(3,LauncherName.EpicGames));
            ...
            Jeux.Add(new Launcher(3,LauncherName.Origin));
            ...
            Jeux.Add(new Launcher(2,LauncherName.Riot));
            ...
            Jeux.Add(new Launcher(1,LauncherName.Steam));
            ...
            Jeux.Add(new Launcher(1,LauncherName.Uplay));
            ...
            Jeux.Add(new Launcher(1,LauncherName.Autre));
            ...
            Data= new Data(Jeux,new List<string>{ });
        }
